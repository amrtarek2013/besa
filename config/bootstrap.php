 ...
 */
// print_r($_GET);
if (!empty($_GET["tz"]) && $_GET["tz"] == "cairo") {
...
function delete_full_folder($dir)
{
...
function clearAllCache()
{
    ...
    $cachefolders = array('views', 'models', 'persistent');
