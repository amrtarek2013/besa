...
$('.all_group').change(function () {
	if (this.checked) {
		$('input[data-all-permission-group="all-permissions"]').prop('checked', true);
	} else {
		$('input[data-all-permission-group="all-permissions"]').prop('checked', false);
	}
...
$(document).ready(function () {
	...
	$('input[data-all-permission-group="all-permissions"]').each(function () {
		if (this.checked) {
		} else {
			all_checked = false;
		}
