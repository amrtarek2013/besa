...
class AcademicCourse extends Entity
{
    ...
    protected function _getImagePath()
    {
        ...
        if (!empty($this->image)) {
            $image_path = 'uploads' . DS . 'academic_courses' . DS . str_replace(DS,"",$this->image);
    ...
    protected function _getThumbImagePath()
    {
        ...
        $no_image_path = DS . 'img' . DS . 'portrait-of-female-un.png';
        if (!empty($this->image)) {
            $image_path = 'uploads' . DS . 'academic_courses' . DS . "thumbs_" . str_replace(DS, "", $this->image);
            if (file_exists(WWW_ROOT . $image_path))
                return DS . $image_path;
            else
    ...
    protected function _getBannerImagePath()
    {
        ...
        if (!empty($this->banner_image)) {
            $image_path = 'uploads' . DS . 'academic_courses' . DS . str_replace(DS,"",$this->banner_image);
            if (file_exists(WWW_ROOT . $image_path))
                return DS . $image_path;
            else
                return $no_image_path;
    ...
    //         $image_path = 'uploads' . DS . 'academic_courses' . DS . str_replace(DS,"",$this->mobile_image);
    //         if (file_exists(WWW_ROOT . $image_path))
    //             return DS . $image_path;
    //         else
    //             return $no_image_path;
