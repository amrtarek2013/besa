...
class SchoolImage extends Entity
{
    ...
    protected function _getImagePath()
    {
        ...
        if (!empty($this->image)) {
            $image_path = 'uploads' . DS . 'school_images' . DS . str_replace(DS, "", $this->image);
    ...
    //         $image_path = 'uploads' . DS . 'school_images' . DS . str_replace(DS,"",$this->mobile_image);
    //         if (file_exists(WWW_ROOT . $image_path))
    //             return DS . $image_path;
    //         else
    //             return $no_image_path;
