...
class School extends Entity
{
    ...
    protected function _getLogoPath()
    {
        ...
        if (!empty($this->logo)) {
            $logo_path = 'uploads' . DS . 'schools' . DS . 'logo' . DS . $this->logo;
    ...
    protected function _getThumbPath()
    {
        ...
        if (!empty($this->image)) {
            $image_path = 'uploads' . DS . 'schools' . DS . 'thumb_' . str_replace(DS, "", $this->image);
    ...
    protected function _getFlagPath()
    {
        ...
        if (!empty($this->flag)) {
            $image_path = 'uploads' . DS . 'schools'  . DS . str_replace(DS, "", $this->flag);
            if (file_exists(WWW_ROOT . $image_path))
                return DS . $image_path;
            else
                return $no_image_path;
    ...
    protected function _getBannerImagePath()
    {
        ...
        if (!empty($this->banner_image)) {
            $image_path = 'uploads' . DS . 'schools' . DS . str_replace(DS, "", $this->banner_image);
            if (file_exists(WWW_ROOT . $image_path))
                return DS . $image_path;
            else
                return $no_image_path;
    ...
    //         $image_path = 'uploads' . DS . 'schools' . DS . str_replace(DS,"",$this->mobile_image);
    //         if (file_exists(WWW_ROOT . $image_path))
    //             return DS . $image_path;
    //         else
    //             return $no_image_path;
