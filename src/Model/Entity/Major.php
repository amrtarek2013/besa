...
class Major extends Entity
{
    ...
    //     if (!empty($this->image)) {
    //         $image_path = 'uploads' . DS . 'majors' . DS . str_replace(DS,"",$this->image);
    ...
    //         $image_path = 'uploads' . DS . 'majors' . DS . str_replace(DS,"",$this->banner_image);
    //         if (file_exists(WWW_ROOT . $image_path))
    //             return DS . $image_path;
    //         else
    //             return $no_image_path;
    ...
    //         $image_path = 'uploads' . DS . 'majors' . DS . str_replace(DS,"",$this->mobile_image);
    //         if (file_exists(WWW_ROOT . $image_path))
    //             return DS . $image_path;
    //         else
    //             return $no_image_path;
