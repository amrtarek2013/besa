 ...
 */
class UpdateRulesTable extends Table
{
    ...
    public function validationDefault(Validator $validator): Validator
    {
        ...
        $validator->notEmptyString('os', 'This field is required.');
        $validator->notEmptyString('current_version', 'This field is required.');
        $validator->notEmptyString('update_url', 'This field is required.');
