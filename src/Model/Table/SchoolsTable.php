...
class SchoolsTable extends Table
{
    ...
    public $filters = [
        'name' => array('type' => 'like', 'options' => array('type' => 'text')),
    ];
    ...
    public function initialize(array $config): void
    {
            ...
            [
                'ImageUpload' => [
                    ...
                    'image' => [
                        ...
                        'path' => 'uploads/schools',
                        'file_name' => '{$rand}_{$file_name}',

                        'thumbs' => [

                            ['thumb_prefix' => 'thumb_', 'width' => '120', 'height' => '50']
                        ],
                    ],
                    // 'mobile_image' => [
        ...
        $this->hasMany('SchoolImages')->setForeignKey('school_id');
    }
