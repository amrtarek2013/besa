...
<script>
    ...
    window.addEventListener("earthjsload", function() {
        ...
        myearth.addEventListener("ready", function() {
            ...
            //             marker.addEventListener('click', openPhoto); // animate marker
            //             setTimeout((function() {
            //                 this.visible = true;
            ...
            // ajax.open("GET", '/miniature-earth/animated_flag.obj', true);
            // ajax.send();
        ...
        myearth.addEventListener("ready", function() {
            ...
            ajax.open("GET", '/miniature-earth/ring.obj', true);
            ajax.send();
            ...
            ajax.open("GET", '/miniature-earth/untitled222.obj', true);
            ajax.send();
        });
        myearth.addEventListener("ready", function() {
            var ajax = new XMLHttpRequest();
