        ...
        <div class="row">
            <div class="col-md-6">
                <div class="background-banner-color">
                    <img src="<?=WEBSITE_URL?>img/hero-bg7.png" alt="" style="z-index: 2;" width="100%" height="100%">
                        ...
                        <?php if (isset($events[1])) { ?>
                            <div class="left-box">
                                <div class="double_img">
                                    ...
                                    ?>
                                    <img src="<?=WEBSITE_URL?>img/dots-153.png" width="100%" height="100%" alt="" class="dots-rel">
                                </div>
                                <div class="text">
