                ...
                <div class="col-md-12">
                    ...
                    <div class="card">
                        <div class="card-header">
                            <h3 class="card-title"><?= __(ucfirst($this->getRequest()->getParam('action')) . ' SchoolImage') ?></h3>
                        </div>

                        <?php
                        $action = $this->request->getParam('action');
                        ?>
                        <?= $this->AdminForm->create($schoolImage, ['type' => 'file', 'id' => $action . 'Form']); ?>
                        <div class="card-body">
                            <?php
                            
                            echo $this->AdminForm->control('school_id', ['type' => 'select', 'option' => $schools, 'class' => 'INPUT required']);
                            ...
                            // //commentimageupload echo $this->AdminForm->enableAjaxUploads($id, 'schoolImage_' . $id, $mainAdminToken);
                        ...
                        <div class="card-footer">
                            ...
                            <?php
                            if (!$schoolImage->isNew()) {

                                echo $this->element('save_as_new', array($schoolImage));
                            }
                            ?>
                        </div>
                        <?= $this->AdminForm->end() ?>
