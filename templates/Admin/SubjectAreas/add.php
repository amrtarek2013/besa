                ...
                <div class="col-md-12">
                    ...
                    <div class="card">
                        <div class="card-header">
                            <h3 class="card-title"><?= __(ucfirst($this->getRequest()->getParam('action')) . ' Subject Area') ?></h3>
                        </div>

                        <?php
                        $action = $this->request->getParam('action');
                        ?>
                        <?= $this->AdminForm->create($subjectArea, ['type' => 'file']); ?>
                        <div class="card-body">
                            <?php
                            echo $this->AdminForm->create($subjectArea, ['type' => 'file', 'id' => $action . 'Form']);
                            ...
                            echo $this->AdminForm->enableAjaxUploads($id, 'subjectArea_' . $id, $mainAdminToken);
                        ...
                        <div class="card-footer">
                            ...
                            <?php
                            if (!$subjectArea->isNew()) {

                                echo $this->element('save_as_new', array($subjectArea));
                            }
                            ?>
                        </div>
                        <?= $this->AdminForm->end() ?>
