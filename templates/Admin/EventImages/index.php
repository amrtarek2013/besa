            ...
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        ...
                        echo $this->List->filter_form($eventImages, $filters, [], [], $parameters, $session) ?>
                    </div>
                    <div class="card">
                        <div class="card-header">
                            <h3 class="card-title"><?= __('Event Images List') ?></h3>
                            <a class="add-new-btn btn btn-primary <?= $currLang == 'en' ? 'float-right' : 'float-left' ?>" href="<?= ADMIN_LINK ?>/eventImages/add">
                                <?= __('Add new') ?>
                            </a>
                        </div>
                        <?php
                        ...
                        $fields = [
                            'basicModel' => 'eventImages',
                            'id' => [],
                            'event_id' => ['format' => 'get_from_array', 'options' => ['items_list' => $events]],
                            'title' => [],
                        ...
                        echo $this->List->adminIndex($fields, $eventImages, $actions, true, $multi_select_actions, $parameters);
                        ?>
