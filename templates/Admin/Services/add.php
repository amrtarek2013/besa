                ...
                <div class="col-md-12">
                    ...
                    <div class="card">
                        <div class="card-header">
                            <h3 class="card-title"><?= __(ucfirst($this->getRequest()->getParam('action')) . '  Service') ?></h3>
                        </div>

                        <?php
                        $action = $this->request->getParam('action');
                        ?>
                        <?= $this->AdminForm->create($service, ['type' => 'file']); ?>
                        <div class="card-body">
                            <?php
                            echo $this->AdminForm->create($service, ['type' => 'file', 'id' => $action . 'Form']);
                            ...
                            echo $this->AdminForm->control('search_degree_options', ['type' => 'select', 'empty' => 'Select Search Degree Option', 'options' => $searchDegreeOptions, 'class' => 'INPUT required']);
                            ...
                            echo $this->AdminForm->control('show_on_footer', ['type' => 'checkbox']);
                            echo $this->AdminForm->control('show_in_search', ['type' => 'checkbox']);
                            echo $this->AdminForm->control('display_order', []);
                            // echo $this->AdminForm->control('is_full_height', ['type' => 'checkbox']);
                            echo $this->AdminForm->enableAjaxUploads($id, 'service_' . $id, $mainAdminToken);
                        ...
                        <div class="card-footer">
                            ...
                            if (!$service->isNew()) {
                                ...
                                echo $this->element('save_as_new', array($service));
                            }
                            ?>
                        </div>
                        <?= $this->AdminForm->end() ?>
