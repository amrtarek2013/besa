            ...
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        ...
                        echo $this->List->filter_form($branches, $filters, [], [], $parameters, $session) ?>
                    </div>
                    <div class="card">
                        <div class="card-header">
                            <h3 class="card-title"><?= __('Branches List') ?></h3>
                            <a class="add-new-btn btn btn-primary <?= $currLang == 'en' ? 'float-right' : 'float-left' ?>" href="<?= ADMIN_LINK ?>/branches/add">
                                <?= __('Add new') ?>
                            </a>
                        </div>
                        <?php
                        ...
                        $fields = [
                            ...
                            'display_order' => [],
                            'active' => ['format' => 'bool'],
                            'is_main_branch' => ['label' => 'Main', 'format' => 'bool'],
                        ];
                        ...
                        echo $this->List->adminIndex($fields, $branches, $actions, true, $multi_select_actions, $parameters);
                        ?>
