            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="card">
                        ...
                        ?>
                        <?= $this->AdminForm->create($careerImage, ['type' => 'file']); ?>
                        <div class="card-body">
                            <?php
                            echo $this->AdminForm->create($careerImage, ['type' => 'file', 'id' => $action . 'Form']);
                        ...
                        <div class="card-footer">
                            ...
                            <?php
                            if (!$careerImage->isNew()) {

                                echo $this->element('save_as_new', array($careerImage));
                            }
                            ?>
                        </div>
                        <?= $this->AdminForm->end() ?>
