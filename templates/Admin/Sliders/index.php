            ...
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        ...
                        echo $this->List->filter_form($sliders, $filters, [], [], $parameters, $session) ?>
                    </div>
                    <div class="card">
                        <div class="card-header">
                            <h3 class="card-title"><?= __('Sliders List') ?></h3>
                            <!-- <a class="add-new-btn btn btn-primary <?= $currLang == 'en' ? 'float-right' : 'float-left' ?>" href="<?= ADMIN_LINK ?>/sliders/add">
                                <?= __('Add new') ?>
                            </a> -->
                        </div>
                        <?php
                        ...
                        echo $this->List->adminIndex($fields, $sliders, $actions, false, $multi_select_actions, $parameters);
                        ?>
