...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1><?= __('Pathway Programs List') ?></h1>
                </div>
                <div class="col-sm-6">
            ...
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        ...
                        echo $this->List->filter_form($pathwayPrograms, $filters, [], [], $parameters, $session) ?>
                    </div>
                    <div class="card">
                        <div class="card-header">
                            <h3 class="card-title"><?= __('Pathway Programs List') ?></h3>
                            <a class="add-new-btn btn btn-primary <?= $currLang == 'en' ? 'float-right' : 'float-left' ?>" href="<?= ADMIN_LINK ?>/pathway-programs/add">
                                <?= __('Add new') ?>
                            </a>
                        </div>
                        <?php
                        ...
                        echo $this->List->adminIndex($fields, $pathwayPrograms, $actions, true, $multi_select_actions, $parameters);
                        ?>
