...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1><?= $categoryTitle != '' ? __($categoryTitle . ' - List') : __('Snippets List') ?></h1>
                </div>
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="<?= ADMIN_LINK ?>"><?= __('Home') ?></a></li>
                        <li class="breadcrumb-item active"><?= $categoryTitle != '' ? __($categoryTitle . ' - List') : __('Snippets List') ?> ?></li>
                    </ol>
                </div>
            </div>
        </div>
                ...
                <div class="col-12">
                    ...
                    <div class="card">
                        <div class="card-header">
                            <h3 class="card-title"><?= $categoryTitle != '' ? __($categoryTitle . ' - List') : __('Snippets List') ?></h3>
                            <!-- <a class="add-new-btn btn btn-primary <?= $currLang == 'en' ? 'float-right' : 'float-left' ?>" href="<?= ADMIN_LINK ?>/snippets/add">
                                <?= __('Add new') ?>
                            </a> -->
                        </div>
                        <?php
