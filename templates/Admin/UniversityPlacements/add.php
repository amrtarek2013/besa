            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <?php
                            echo $this->AdminForm->create($universityPlacement, ['type' => 'file', 'id' => $action . 'Form']);
                            ...
                            // echo $this->AdminForm->enableAjaxUploads($id, 'universityPlacement_' . $id, $mainAdminToken);
