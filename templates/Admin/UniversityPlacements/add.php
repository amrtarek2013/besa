<div class="content-wrapper">
    ...
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1><?= __('University Placements') ?></h1>
                </div>
                <div class="col-sm-6">
                ...
                <div class="col-md-12">
                    ...
                    <div class="card">
                        <div class="card-header">
                            <h3 class="card-title"><?= __(ucfirst($this->getRequest()->getParam('action')) . ' University Placement') ?></h3>
                        </div>
                        ...
                        $class = 'editor';
                        ?>
                        <?= $this->AdminForm->create($universityPlacement, ['type' => 'file', 'id' => $action . 'Form']); ?>
                        <div class="card-body">
                            <?php
                            ...
                            // //commentimageupload echo $this->AdminForm->enableAjaxUploads($id, 'universityPlacement_' . $id, $mainAdminToken);
                        ...
                        <div class="card-footer">
                            ...
                            <?php
                            if (!$universityPlacement->isNew()) {

                                echo $this->element('save_as_new', array($universityPlacement));
                            }
                            ?>
                        </div>
                        <?= $this->AdminForm->end() ?>
