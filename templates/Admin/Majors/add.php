            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="card">
                        ...
                        ?>
                        <?= $this->AdminForm->create($major, ['type' => 'file']); ?>
                        <div class="card-body">
                            <?php
                            echo $this->AdminForm->create($major, ['type' => 'file', 'id' => $action . 'Form']);
                            ...
                            echo $this->AdminForm->enableAjaxUploads($id, 'major_' . $id, $mainAdminToken);
