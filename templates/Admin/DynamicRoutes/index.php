            ...
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        ...
                        echo $this->List->filter_form($dynamicRoutes, $filters, [], [], $parameters, $session) ?>
                    </div>
                    <div class="card">
                        <div class="card-header">
                            <h3 class="card-title"><?= __('Dynamic Routes List') ?></h3>
                        ...
                        $fields = [
                            ...
                            'has_params' => ['format' => 'bool'],
                            'is_active' => ['format' => 'bool'],
                        ];
                        ...
                        echo $this->List->adminIndex($fields, $dynamicRoutes, $actions, true, $multi_select_actions, $parameters);
                        ?>
