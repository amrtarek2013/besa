...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1><?= __('Counselor Invoices List') ?></h1>
                </div>
                <div class="col-sm-6">
            ...
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        ...
                        echo $this->List->filter_form($counselorInvoices, $filters, [], [], $parameters, $session) ?>
                    </div>
                    <div class="card">
                        <div class="card-header">
                            <h3 class="card-title"><?= __('Counselor Invoices List') ?></h3>
                        ...
                        $fields = [
                            ...
                            'is_paid' => ['format' => 'bool'],
                            'created' => [],
                            'transaction_time' => ['date_format' => 'd/m/Y H:i:s'],
                        ];
