...
<div class="content-wrapper">
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1><?= __($mainEventTitle.' Events List') ?></h1>
                </div>
                <div class="col-sm-6">
            ...
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        ...
                        echo $this->List->filter_form($fairEvents, $filters, [], [], $parameters, $session) ?>
                    </div>
                    <div class="card">
                        <div class="card-header">
                            <h3 class="card-title"><?= __($mainEventTitle.' Events List') ?></h3>
                            <a class="add-new-btn btn btn-primary <?= $currLang == 'en' ? 'float-right' : 'float-left' ?>" href="<?= ADMIN_LINK ?>/FairEvents/add">
                                <?= __('Add new') ?>
                            </a>
                        </div>
                        <?php $fields = [
                            'basicModel' => 'fairEvents',
                            'id' => [],
                            'title' => [],
                        ...
                        echo $this->List->adminIndex($fields, $fairEvents, $actions, false, $multi_select_actions, $parameters);
                        ?>
                    </div>
                </div>
            </div>
