            ...
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        ...
                        echo $this->List->filter_form($aboutusSliders, $filters, [], [], $parameters, $session) ?>
                    </div>
                    <div class="card">
                        <div class="card-header">
                            <h3 class="card-title"><?= __('Aboutus Sliders List') ?></h3>
                        ...
                        echo $this->List->adminIndex($fields, $aboutusSliders, $actions, true, $multi_select_actions, $parameters);
                        ?>
