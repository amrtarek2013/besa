            ...
            <div class="col-12">
                ...
                <div class="card">
                    <?php
                        ...
                        echo $this->List->filter_form($roles, $filters, [], [], $parameters, $session);
                    ?>
                </div>
                ...
                <div class="card">
                    <div class="card-header">
                        ...
                        <a class="add-new-btn btn btn-primary <?=$currLang=='en'?'float-right':'float-left'?>" href="<?=ADMIN_LINK?>/roles/add">
                            <?=__('Add new')?>
                        </a>
                    </div>
                    ...
                    <?php
                        ...
                        echo $this->List->adminIndex($fields, $roles, $actions, true, $multi_select_actions, $parameters);
                    ?>
                </div>
