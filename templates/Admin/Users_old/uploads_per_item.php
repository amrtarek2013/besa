...
<div class="content-wrapper">
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0"><?=__('Uploads Per Item')?></h1>
                </div>
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="<?=ADMIN_LINK?>"><?=__('Home')?></a></li>
                        <li class="breadcrumb-item active"><?=__('Uploads Per Item')?></li>
                    </ol>
                </div>
            </div>
        </div>
        ...
        <div class="container-fluid">
                ...
                <div class="col-lg-12">
                    ...
                    <?= $this->AdminForm->create($user, ['type' => 'file','id'=>'filter_form']) ?>
                        ...
                        <div class="card-body row">
                            ...
                            <input type="hidden" name="sort" value="lesson_id" id="sort_value">
            ...
            <div class="row">
                    ...
                    <div class="card">
                        <div class="card-header border-0">
                            <div class="d-flex justify-content-between">
                                <h3 class="card-title card-title-report"><?=__('Total uploads per item')?></h3>
                        ...
                        <div class="card-body">
                            ...
                            <div class="d-flex flex-row justify-content-end">
                                <span class="mr-2">
                                    <i class="fas fa-square text-primary"></i> <?=__('Uploads per item')?>
                                </span>
                                <!-- <span>
                ...
                <div class="col-lg-6">        
                    <div class="card">
                        <div class="card-header border-0">
                            <h3 class="card-title card-title-report"><?=__('Uploads per item Report')?></h3>
                            <div class="card-tools">
                                <a href="#" class="btn btn-tool btn-sm export_btn" ><i class="fas fa-download"></i></a>
                            </div>
                        </div>
                        <div class="card-body table-responsive p-0">
                            <table class="table table-striped table-valign-middle">
                                <thead>
                                    <tr>
                                    <th>
                                        <a href="#" data-sort="lesson_id" data-dir="<?=$dir?>" class="datatable_sorting custom_sorting">
                                            <?=__('Item')?> <i class="fas fa-sort"></i>
                                        </a>
                                    </th>
                                    <th>
                                ...
                                <tbody>
                                    <?php foreach ($uploads_count_per_item as $key => $value) { ?>
                                        <tr>
                                            <td><?=$value->lesson_item?></td>
