                    ...
                    <div class="card">
                        ...
                        $actions = [
                            ...
                            array(
                                ...
                                'condition' => '$row["id"]==4',
                                'value' => $this->Html->link(__('Trophy Event', true), array('controller' => 'fair-events', 'action' => 'index', '%id%'), array('class' => 'btn btn-warning btn-sm', 'icon' => 'fas fa-arrow-right')),
                            ), array(
                                'condition' => '$row["id"]==6',
                                'value' => $this->Html->link(__('Tours Event', true), array('controller' => 'fair-events', 'action' => 'index', '%id%'), array('class' => 'btn btn-warning btn-sm', 'icon' => 'fas fa-arrow-right')),
                            ),
