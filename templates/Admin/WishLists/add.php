                ...
                <div class="col-md-12">
                    ...
                    <div class="card">
                        <div class="card-header">
                            <h3 class="card-title"><?= __(ucfirst($this->getRequest()->getParam('action')) . '  WishList') ?></h3>
                        </div>

                        <?php
                        $action = $this->request->getParam('action');
                        ?>
                        <?= $this->AdminForm->create($wishList, ['type' => 'file']); ?>
                        <div class="card-body">
                            <?php
                            echo $this->AdminForm->create($wishList, ['type' => 'file', 'id' => $action . 'Form']);
                            ...
                            echo $this->AdminForm->control('top_text', ['type' => 'textarea', 'class' => 'editor AddFrontCss']);
                        ...
                        <div class="card-footer">
                            ...
                            if (!$wishList->isNew()) {
                                ...
                                echo $this->element('save_as_new', array($wishList));
                            }
                            ?>
                        </div>
                        <?= $this->AdminForm->end() ?>
