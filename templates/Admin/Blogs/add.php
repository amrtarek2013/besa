            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="card">
                        ...
                        ?>
                        <?= $this->AdminForm->create($blog, ['type' => 'file']); ?>
                        <div class="card-body">
                            <?php
                            echo $this->AdminForm->create($blog, ['type' => 'file', 'id' => $action . 'Form']);
                            ...
                            // echo $this->AdminForm->enableAjaxUploads($id, 'blog_' . $id, $mainAdminToken);
