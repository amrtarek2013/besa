...
foreach ($days as $k =>  $day) {
	...
	$availableDate = isset($userWorkDayTimes[$day_id]) ? $userWorkDayTimes[$day_id] : $defult_settings;
	@$from = ($availableDate && $availableDate->time != null) ? $availableDate->time : $agent_time_configs['time.default_agent_chat_time_from'];


	echo $this->AdminForm->hidden("UserWorkDayTimes.$i.id", array("value" => @$availableDate->id, "class" => "input required"));
	?>
        <div class="row bottom-line">
            ...
            <div class="col-md-2" style="align-self: center;">
                <div >
                    ...
                    <?php
	echo $this->AdminForm->hidden("UserWorkDayTimes.$i.day", array("value" => $day_id));
	...
	?>
            ...
            <div class="col-md-2">
                <?php
echo $this->AdminForm->control("UserWorkDayTimes.$i.active", array("type" => "checkbox", 'label' => 'On/Off', 'checked' => $availableDate['active'], "class" => "input chceckbox"));
	?>
            </div>
            ...
            <div class="col-md-3">
                <?php
echo $this->AdminForm->control("UserWorkDayTimes.$i.time", array("type" => "text", 'value' => $from, "class" => "input Time required Time_" . $i));
	?>
            </div>
...
echo $this->Html->script(array('select2', 'chzn-choices', 'chosen.ajaxaddition.jquery.js?v=111', '//code.jquery.com/ui/1.10.3/jquery-ui.min.js',
