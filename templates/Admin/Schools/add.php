                ...
                <div class="col-md-12">
                    ...
                    <div class="card">
                        <div class="card-header">
                            <h3 class="card-title"><?= __(ucfirst($this->getRequest()->getParam('action')) . ' School') ?></h3>
                        </div>

                        <?php
                        $action = $this->request->getParam('action');
                        ?>
                        <?= $this->AdminForm->create($school, ['type' => 'file']); ?>
                        <div class="card-body">
                            <?php
                            echo $this->AdminForm->create($school, ['type' => 'file', 'id' => $action . 'Form']);


                            echo $this->AdminForm->control('name', ['type' => 'text', 'class' => 'INPUT required', 'required' => true]);
                            ...
                            // //commentimageupload echo $this->AdminForm->enableAjaxUploads($id, 'school_' . $id, $mainAdminToken);
                        ...
                        <div class="card-footer">
                            ...
                            if (!$school->isNew()) {
                                ...
                                echo $this->element('save_as_new', array($school));
                            }
                            ?>
                        </div>
                        <?= $this->AdminForm->end() ?>
