            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="card">
                        ...
                        ?>
                        <?= $this->AdminForm->create($countryImage, ['type' => 'file', 'id' => $action . 'Form']); ?>
                        <div class="card-body">
                            <?php
                            ...
                            // //commentimageupload echo $this->AdminForm->enableAjaxUploads($id, 'countryImage_' . $id, $mainAdminToken);
