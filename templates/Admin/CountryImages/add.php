<div class="content-wrapper">
    ...
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1><?= __('Country Images') ?></h1>
                </div>
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="/">Home</a></li>
                        <li class="breadcrumb-item active"><?= __('Country Images') ?></li>
                    </ol>
                </div>
            </div>
        </div>
                ...
                <div class="col-md-12">
                    ...
                    <div class="card">
                        <div class="card-header">
                            <h3 class="card-title"><?= __(ucfirst($this->getRequest()->getParam('action')) . ' CountryImage') ?></h3>
                        </div>

                        <?php
                        $action = $this->request->getParam('action');
                        ?>
                        <?= $this->AdminForm->create($countryImage, ['type' => 'file']); ?>
                        <div class="card-body">
                            <?php
                            echo $this->AdminForm->create($countryImage, ['type' => 'file', 'id' => $action . 'Form']);
                            ...
                            // echo $this->AdminForm->enableAjaxUploads($id, 'countryImage_' . $id, $mainAdminToken);
                        ...
                        <div class="card-footer">
                            ...
                            <?php
                            if (!$countryImage->isNew()) {

                                echo $this->element('save_as_new', array($countryImage));
                            }
                            ?>
                        </div>
                        <?= $this->AdminForm->end() ?>
