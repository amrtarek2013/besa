            ...
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        ...
                        echo $this->List->filter_form($countryImages, $filters, [], [], $parameters, $session) ?>
                    </div>
                    <div class="card">
                        ...
                        $fields = [
                            'basicModel' => 'countryImages',
                            'id' => [],
                            'country_id' => ['format' => 'get_from_array', 'options' => ['items_list' => $countries]],
                            'title' => [],
                        ...
                        echo $this->List->adminIndex($fields, $countryImages, $actions, true, $multi_select_actions, $parameters);
                        ?>
