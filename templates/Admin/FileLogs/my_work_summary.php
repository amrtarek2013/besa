...
<section class="content-header">
    <div class="container-fluid">
        <div class="row mb-2">
            <div class="col-sm-6">
                <h1><?=__('My Work Summary')?></h1>
            </div>
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                    <li class="breadcrumb-item"><a href="<?=ADMIN_LINK?>"><?=__('Home')?></a></li>
                    <li class="breadcrumb-item active"><?=__('My Work Summary')?></li>
                </ol>
            </div>
        </div>
    </div>
            ...
            <div class="col-12">
                ...
                <div class="card">
                    <?php
                        ...
                        echo $this->List->filter_form(null, $filters, [], ["filter_title"=>"Show Work Summary"], $parameters, $session);
                    ?>
                </div>
            <?php if(!empty($files)){ ?>
                <div class="card">
