  	...
  	<div class="container-fluid">
		...
		<div class="row mt-5">
			<div class="col-md-6 center-block">
				<button type="button" class="btn btn-primary load-files-btn" id="load-review-files"><i class="fa fa-download"></i> <?=__('Load Files')?></button>
			</div>
            <div class="col-md-6 center-block">
                <button type="button" class="btn btn-dark files_submition_btn submit_reviewed_files" ><i class="fa fa-check-circle"></i> <?=__('Submit Reviewed Files')?></button>
            </div>
		</div>
                ...
                <div class="col-sm-9">
                    <div id="review-files">
                        ...
                        if(!empty($files_to_review)){
                            echo $this->element('../Files/review_boxes', array($files_to_review));
                        }else{
