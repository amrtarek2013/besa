...
<section class="content-header">
  	<div class="container-fluid">
    	<div class="row mb-2">
      		<div class="col-sm-6">
        		<h1><?=__('Files Annotation')?></h1>
      		</div>
      		<div class="col-sm-6">
        		<ol class="breadcrumb float-sm-right">
          			<li class="breadcrumb-item"><a href="/"><?=__('Home')?></a></li>
          			<li class="breadcrumb-item active"><?=__('Annotation')?></li>
        		</ol>
      		</div>
    	</div>
		...
		<div class="row mt-5">
			<div class="col-md-6 center-block">
				<button type="button" class="btn btn-primary load-files-btn" id="load-annotation-files"><i class="fa fa-download"></i> <?=__('Load Files')?></button>
			</div>
            <div class="col-md-6 center-block">
                <button type="button" class="btn btn-dark files_submition_btn submit_annotated_files" ><i class="fa fa-check-circle"></i> <?=__('Submit Annotated Files')?></button>
            </div>
		</div>
  	...
  	<div class="card card-solid">
    	<div class="card-body pb-0">
            ...
            <div class="row">
                ...
                <div class="col-sm-9">
                    <div id="annotation-files">
                        <?php 
                        if(!empty($files_to_annotate)){
                            echo $this->element('../Files/annotation_boxes', array($files_to_annotate));
                        }else{
