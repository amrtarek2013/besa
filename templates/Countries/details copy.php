<section class="secondry-banner unitedKingdom"  style="background: url(<?= $country['banner_image_path'] ?>) !important">
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                <div class="breadcrumb">
                    <h1 class=""><?= $country['country_name'] ?></h1>
                </div>
            </div>
        </div>
    </div>
    <div class="extra-bar">
        <h4 class="title"><?= $country['title'] ?></h4>
    </div>
</section>
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="gridWhyStudy">
                    ...
                    <div class="text">
                        <h4 class="title">
                            Why Study In The <?= $country['country_code'] ?>?
                        </h4>
