            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item active"><?= __('Applications') ?></li>
                    </ol>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        ...
                        echo $this->List->filter_form($applications, $filters, [], [], $parameters, $session) ?>
                    </div>
                    <div class="card">
                        ...
                        echo $this->List->adminIndex($fields, $applications, $actions, true, $multi_select_actions, $parameters);
                        ?>
