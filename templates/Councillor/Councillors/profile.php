<section class="main-banner register-banner">
    ...
    <div class="container"  style="width:100%">
        ...
        <div class="row">
            ...
            <?= $this->Form->create($councillor, array('id' => 'FormProfile')); ?>
            <div class="col-md-12">
            ...
            <div class="col-md-12">
                <div class="container-formBox blue-border">
                    ...
                    <div class="grid-container">
                        <?= $this->Form->control('study_level_id', ['placeholder' => 'Level of study', 'type' => 'select', 'empty' => 'Select Level of study*', 'options' => $studyLevels, 'class' => 'form-area', 'label' => 'Level of study*', 'required' => true]) ?>
